...
TEST(string, convert_to) {
    ...
    EXPECT_DOUBLE_EQ(kw::String("-1234567890.1234567890").to<double>(), -1234567890.1234567890);
    EXPECT_DOUBLE_EQ(kw::String("-1234567890.1234567890").to<long double>(), -1234567890.1234567890);
