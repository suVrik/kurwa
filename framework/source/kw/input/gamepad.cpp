...
HashMap<uint8, Control> controls_conversion = {
    { SDL_CONTROLLER_BUTTON_A, Control::CONTROL_A },
    { SDL_CONTROLLER_BUTTON_B, Control::CONTROL_B },
    { SDL_CONTROLLER_BUTTON_X, Control::CONTROL_X },
    { SDL_CONTROLLER_BUTTON_Y, Control::CONTROL_Y },
    { SDL_CONTROLLER_BUTTON_BACK, Control::CONTROL_BACK },
    { SDL_CONTROLLER_BUTTON_GUIDE, Control::CONTROL_GUIDE },
    { SDL_CONTROLLER_BUTTON_START, Control::CONTROL_START },
    { SDL_CONTROLLER_BUTTON_LEFTSTICK, Control::CONTROL_LEFT_STICK },
    { SDL_CONTROLLER_BUTTON_RIGHTSTICK, Control::CONTROL_RIGHT_STICK },
    { SDL_CONTROLLER_BUTTON_LEFTSHOULDER, Control::CONTROL_LEFT_SHOULDER },
    { SDL_CONTROLLER_BUTTON_RIGHTSHOULDER, Control::CONTROL_RIGHT_SHOULDER },
    { SDL_CONTROLLER_BUTTON_DPAD_UP, Control::CONTROL_DPAD_UP },
    { SDL_CONTROLLER_BUTTON_DPAD_DOWN, Control::CONTROL_DPAD_DOWN },
    { SDL_CONTROLLER_BUTTON_DPAD_LEFT, Control::CONTROL_DPAD_LEFT },
    { SDL_CONTROLLER_BUTTON_DPAD_RIGHT, Control::CONTROL_DPAD_RIGHT },
};
