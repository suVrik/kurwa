...
void BackendVk::create_instance() {
...
void BackendVk::pick_physical_device() {
...
bool BackendVk::is_device_suitable(VkPhysicalDevice device) {
...
int32_t BackendVk::get_suitable_queue_family_id(const VkPhysicalDevice& device) {
...
void BackendVk::create_logical_device() {
...
kw::Vector<const char*> BackendVk::get_instance_extensions() {
...
const kw::Vector<const char*> BackendVk::device_extensions = {
        "VK_KHR_swapchain"
};

bool BackendVk::check_device_extension_support(VkPhysicalDevice device) {
...
BackendVk::SwapChainSupportDetails BackendVk::query_swapchain_support(VkPhysicalDevice device) {
...
VkSurfaceFormatKHR BackendVk::choose_swap_surface_format(const kw::Vector<VkSurfaceFormatKHR>& available_formats) {
...
VkExtent2D BackendVk::choose_swap_extent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void BackendVk::create_swapchain() {
...
void BackendVk::create_image_views() {
...
void BackendVk::create_render_pass() {
...
void BackendVk::create_framebuffers() {
...
void BackendVk::create_command_pool() {
...
uint32_t BackendVk::acquire_next_frame() const {
...
void BackendVk::draw_frame(uint32_t image_index) {
...
void BackendVk::create_sync_objects() {
...
void BackendVk::callocate_command_buffers() {
...
BackendVk::BackendVk(kw::IGame* game) noexcept {
    game->on_init.connect(this, &BackendVk::on_init_listener);
};
...
void BackendVk::on_init_listener(kw::IGame *game) {
...
void BackendVk::process_command_buffer(CommandBuffer&& command_buffer) {
